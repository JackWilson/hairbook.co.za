...
class StylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stylist" do
    assert_difference('Stylist.count') do
      post stylists_url, params: { stylist: { image_url: @stylist.image_url, name: @stylist.name } }
    end
  ...
  test "should update stylist" do
    patch stylist_url(@stylist), params: { stylist: { image_url: @stylist.image_url, name: @stylist.name } }
